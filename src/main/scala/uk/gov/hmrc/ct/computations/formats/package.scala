...
package object formats {
  ...
  implicit val cp81InputFormat: Format[CP81] = new OptionalIntegerFormat[CP81](CP81.apply)
  ...
  implicit val cp252Format: Format[CP252] = new IntegerFormat[CP252](CP252.apply)
